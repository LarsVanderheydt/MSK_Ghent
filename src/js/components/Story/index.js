...
const Story = ({selectPainting, transcript, resetTranscript, switchStarted, screenNr, word, addToStory, setWord, switchPopover, isActive}) => {
  let toStart = 1;
  ...
  return (
      <div>
        ...
        {screenNr === 5 ? <h1 className='postcard_title'>JOUW STEM IS EEN VERHAAL WAARD</h1> : ``}
        <Words />
